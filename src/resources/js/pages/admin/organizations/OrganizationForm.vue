            ...
            <div class="grid gap-4 md:grid-cols-2">
              ...
              <div class="space-y-2 md:col-span-2">
                ...
                <textarea
                  ...
                  class="border-input ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring min-h-[90px] w-full rounded-md border bg-transparent px-3 py-2 text-sm outline-none transition-[border,box-shadow] focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-offset-2"
            ...
            <div class="space-y-3 rounded-lg border border-border/70 p-4">
              <div class="flex items-center justify-between gap-3">
                ...
                <div class="flex flex-1 flex-col gap-2 md:flex-row md:items-center">
                  ...
                  <Button
                    type="button"
                    :disabled="addingUser || isLoadingOrganization || !selectedUser"
                    @click="addUser()"
                  >
