...
<template>
    <AuthBase title="Log in to your account" description="Enter your email and password below to log in">
        ...
        >
            ...
            <div v-if="$page.props?.auth?.registerUrl" class="text-center text-sm text-muted-foreground">
                Don't have an account?
                <TextLink :href="$page.props?.auth?.registerUrl" :tabindex="5">Sign up</TextLink>
            </div>
        </Form>
    </AuthBase>
</template>
