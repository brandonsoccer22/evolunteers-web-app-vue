...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'middleware' => ['auth', 'verified', 'role:Admin,Organization Manager']], function () {
    ...
    Route::group(['as' => 'opportunities.', 'prefix' => 'opportunities'], function () {
        ...
        Route::get('create', [AdminOpportunityController::class, 'showCreate'])->name('create');
        Route::post('', [AdminOpportunityController::class, 'store']) ->name('store');
        Route::get('{opportunity}', [AdminOpportunityController::class, 'show']) ->name('show');
        Route::post('{opportunity}/organizations/{organization}', [AdminOpportunityController::class, 'attachOrganization'])->name('organizations.attach');
        Route::delete('{opportunity}/organizations/{organization}', [AdminOpportunityController::class, 'detachOrganization'])->name('organizations.detach');
        Route::post('{opportunity}/tags', [AdminOpportunityController::class, 'addTag'])->name('tags.add');
        Route::delete('{opportunity}/tags', [AdminOpportunityController::class, 'removeTag'])->name('tags.remove');
        Route::patch('{opportunity}', [AdminOpportunityController::class, 'update'])->name('update');
    ...
    Route::group(['as' => 'organizations.', 'prefix' => 'organizations'], function () {
        ...
        Route::post('{organization}/users/{user}', [AdminOrganizationController::class, 'attachUser'])->name('users.attach')->middleware('role:Admin');
        Route::delete('{organization}/users/{user}', [AdminOrganizationController::class, 'detachUser'])->name('users.detach')->middleware('role:Admin');
    });
});
